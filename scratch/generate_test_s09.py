"""
Script to generate tests/test_smc_strategy_s09.py containing 106 exhaustive tests
for S09 ICT Silver Bullet Strategy Template.
"""
...
# Base anchor: Wednesday 2024-05-15 at 10:00 AM NY time (14:00 UTC, EDT)
...
def _make_sweep(
    ...
    return LiquiditySweepSnapshot(
        ...
        swept_at=swept_at if swept_at is not None else index,
        confirmed_at=confirmed_at if confirmed_at is not None else index,
        mode=mode,
        valid=valid,
...
print("Successfully wrote header and helpers into test_smc_strategy_s09.py")
print("Generated scratch/generate_test_s09.py")
